...
class MetingJSElement extends HTMLElement {
    ...
    _init() {
        ...
        this.config = a, this.api = this.meta.api || window.meting_api || "https://meting.api.feilong.online/?server=:server&type=:type&id=:id&r=:r", this.meta.auto && this._parse_link()
    }
    _parse_link() {
        let a = [
